...
map("n", "<leader>o", "<CMD>FzfLua lsp_outgoing_calls<CR>", bufopts)
map("n", "<leader>c", "<CMD>FzfLua lsp_incoming_calls<CR>", bufopts)
map("n", "<leader>r", "<CMD>FzfLua lsp_references<CR>", bufopts)
map("n", "<leader>d", "<CMD>FzfLua lsp_definitions<CR>", bufopts)
map("n", "<leader>i", "<CMD>FzfLua lsp_implementations<CR>", bufopts)
